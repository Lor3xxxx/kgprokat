...
CREATE TABLE "Unit" (
    ...
    CONSTRAINT "Unit_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "Equipment" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "Rental" (
    ...
    CONSTRAINT "Rental_unitId_fkey" FOREIGN KEY ("unitId") REFERENCES "Unit" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Rental_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Setting" (
    ...
    "depositVerified" REAL NOT NULL DEFAULT 0.5,
    "depositRegular" REAL NOT NULL DEFAULT 0.0,
    "depositBlacklist" REAL NOT NULL DEFAULT 1.0
);
